...
const newsArticles = [
  {
    ...
    body: [
      ...
      'CENTAM was founded by Berfu Göksel, Margherita Beretta, Mia Kovac, Sebastian Meyers, and Waut Declercq, who together bring deep, combined experience in additive manufacturing, advanced ceramics, and silicon carbide processing. Long before the company existed, the founding team had already collaborated as colleagues, researchers, and engineers. Through sustained engagement with industry, they identified a recurring challenge: demand for complex Si-SiC components was growing steadily, while manufacturing options remained limited, costly, and largely constrained by conventional production methods.',
