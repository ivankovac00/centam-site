...
/* =============================================================
   CENTAM — Nieuwsgegevens (Nederlandse versie)
   -------------------------------------------------------------
   Nederlandse vertaling van news.js. Zelfde structuur en
   dezelfde `id` waarden, zodat news-article.html?id=<id> naar
   het juiste artikel verwijst in beide taalversies. Voeg een
   nieuw artikel toe in news.js EN hier, met identieke `id`.
   ============================================================= */
const newsArticles = [
  {
